        ...
        <div class="col-md-8">
                <div class="font-bold text-lg mb-4">{{ __('Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <input type="text" class="border border-gray-400 p-2 w-full" name="email" id="email" value="{{ old('email') }}" required>
                        ...
                        <input type="password" class="border border-gray-400 p-2 w-full" name="password_confirmation" id="password" required>
